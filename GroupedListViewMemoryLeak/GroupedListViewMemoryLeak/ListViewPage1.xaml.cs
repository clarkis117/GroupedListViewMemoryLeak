...
namespace GroupedListViewMemoryLeak
{
	...
	public partial class ListViewPage1 : ContentPage
	{
		public ListViewPage1()
		{
			...
			var switchBindingContext = new Command(() => {
				//this.listView.ItemsSource = null;

				if (listView.IsGroupingEnabled)
					listView.SetBinding(ListView.ItemsSourceProperty, new Binding("Items"));
				else
					listView.SetBinding(ListView.ItemsSourceProperty, new Binding("ItemsGrouped"));


				listView.IsGroupingEnabled = !listView.IsGroupingEnabled;
			});

			SwitchListContextBtn.Command = switchBindingContext;
		}
	...
	internal class ListViewPage1ViewModel : INotifyPropertyChanged
	{
